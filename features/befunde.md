...
| BF-126 | B14 | **Die Spec beschreibt an fünf Stellen einen überholten Stand.** AK-21 („keine Ablauffrist"), AK-22 („kein Widerrufsweg") und AK-23 („geteiltes Kontingent") sind durch BF-36/37/38 erledigt und seit `v2026.08.29` live; AK-17 zählt die erfassten Daten abschließend auf, es sind aber drei Spalten mehr (`marketing_consent_at`, `self_confirmed_at`, `restaurant_id`); AK-04 siehe BF-124. ⚠ Wer die Spec heute liest, hält drei behobene DSGVO-relevante Mängel für offen. Genau die Falle, vor der `CLAUDE.md` bei `B`-Features warnt | mittel | `features/B14-partner-warteliste/spec.md` (AK-04, AK-17, AK-21 bis AK-23) | offen |
